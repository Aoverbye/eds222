...
rootdir <- "~/eds222/eds222/eds222_labs"
...
```{r}
#Home ownership is a categorical variable bc of "fct"
...
```{r}
#First object: make homeownership variables all lower case
# you can call < an alligator mouth
# he says translator for pipe operartor is "And then"
# using mutate and string r to lower
...
# Change order by releveling, does this make it a nominal factor?
...
# calculating proportions, we divide by sum(n) to get proportions  
ggplot(data = loans_sum) +
